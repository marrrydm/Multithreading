...
public class Moped implements Transport {
    ...
    public Moped(String brand, int size){
        ...
        for (int i = 0;i < size;i++){
            models.addLast(new Moped.Model("Мопед" + (i + 1)  , 100.0 * (i + 1)));
        }
    }
